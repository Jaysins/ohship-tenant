...
/**
 * Example of Login page with tenant configuration support
 * This demonstrates how the configurable theme integrates seamlessly
 */
const LoginConfigurable = () => {
      ...
      >
        ...
        <div className="text-center mb-8">
          {branding.logo_url ? (
            ...
            <div
              className={`inline-flex items-center justify-center w-16 h-16 ${getBorderRadius('2xl')} mb-4`}
              style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {apiError && (
              <motion.div
                ...
                className={`p-4 border text-sm ${getBorderRadius('lg')}`}
                style={{
        ...
        >
          ...
          <a href={links.terms_url} className="hover:underline" style={{ color: theme.primary_color }}>
            Terms of Service
          </a>
          {' '}and{' '}
          <a href={links.privacy_url} className="hover:underline" style={{ color: theme.primary_color }}>
            Privacy Policy
          </a>
        </p>
        ...
        {features.show_support_section && (
          <div
            className={`mt-6 p-4 ${getBorderRadius('lg')}`}
            style={{
              backgroundColor: `${theme.info_color}0D`,
              borderLeft: `4px solid ${theme.info_color}`
            }}
          >
...
export default LoginConfigurable;
